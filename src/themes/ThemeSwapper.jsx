...
export const ThemeSwapper = () => {
    const [anchorEl, setAnchorEl] = useState(null); // Removed TypeScript type annotation
    ...
    const [themeName, setThemeName] = useStore('themeName', 'soft'); // Removed TypeScript type annotation
...
const ucFirst = (str) => str.charAt(0).toUpperCase() + str.slice(1); // Removed TypeScript type annotation
